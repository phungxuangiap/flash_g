...
export async function createNewDesk(desk: Desk): Promise<any> {
  return await getLocalDatabase()
    .then(async (db: SQLite.SQLiteDatabase) => {
      return await db.executeSql(createNewDeskQuery, [desk._id, desk.user_id, desk.author_id, desk.original_id, desk.access_status, desk.title, desk.description, desk.primary_color, desk.new_card, desk.inprogress_card, desk.preview_card, desk.modified_time, desk.remote_id]);
    })
    .catch((error) => {
      console.log(error);
    });
...
export async function updateDesk(desk: Desk): Promise<any> {
  return await getLocalDatabase()
    .then(async (db: SQLite.SQLiteDatabase) => {
      await db.executeSql(updateDeskQuery, [desk._id, desk.user_id, desk.author_id, desk.original_id, desk.access_status, desk.title, desk.description, desk.primary_color, desk.new_card, desk.inprogress_card, desk.preview_card, desk.modified_time, desk.remote_id]);
    })
    .catch((error) => {
      console.log(error);
    });
